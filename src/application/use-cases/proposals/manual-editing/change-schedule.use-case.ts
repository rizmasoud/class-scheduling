import { ProposalId, ProposalClassId } from '@/domain/models';
...
export class ChangeProposalClassScheduleUseCase extends BaseManualEditUseCase {
  constructor(
  ...
  async execute(dto: ChangeClassScheduleDTO): Promise<void> {
