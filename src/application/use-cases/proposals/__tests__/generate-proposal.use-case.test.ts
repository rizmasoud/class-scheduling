...
describe('GenerateProposalUseCase', () => {
  it('should generate a proposal draft successfully', async () => {
    ...
    const fakeProposal: SchedulingProposal = {
      ...
      status: 'Draft',
      notes: null,
      classes: [{ id: 'class-1', proposalId: 'prop-1', bookId: 'b-1', teacherId: 't-1', status: 'Pending', score: 10, reasons: [], generatedName: 'Class 1', customName: null, editedBySupervisor: false, notes: null, studentIds: [] }]
    };
